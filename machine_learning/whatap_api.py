...
def listServers(pcode = 0, stime=0, etime=0,protocol='http', host='dev.whatap.io:8080'):
...
def listProcess(pcode=0, oid=0, stime=0, etime=0,protocol='http', host='dev.whatap.io:8080'):
    url = '{}://{}/yard/api'.format(protocol, host)
    headers = {'Cookie': cookie, 'Content-Type': 'application/json'}
